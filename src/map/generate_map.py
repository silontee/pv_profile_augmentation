...
PARQUET_PATH = ROOT / "src/data/processed/pv_facility_processed.parquet"
INFRA_DIR = ROOT / "src/data/openinframap/by_sido"
BOUNDARY_PATH = ROOT / "src/data/boundaries/sigungu_2018_simple.geojson"
OUTPUT_PATH = ROOT / "src/map/output/pv_map.html"
