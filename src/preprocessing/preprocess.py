...
DEFAULT_RAW_CSV_DIR = ROOT / "src/data/raw_csv"
DEFAULT_OUTPUT_DIR = ROOT / "src/data/processed"
DEFAULT_CACHE_PATH = ROOT / "src/data/logs/geocode/geocode_cache_kakao_raw.csv"
DEFAULT_FAILURES_PATH = ROOT / "src/data/logs/geocode/geocode_failures_kakao_raw.csv"
DEFAULT_CRAWLER_STATE = ROOT / "src/data/logs/crawler/pv_facility_profile_state.csv"
